...
download(server, port, user, paswd, local_file_path=f"data/pesteh{today}_1.geojson", remote_file=f"pesteh{today}_1.geojson")
download(server, port, user, paswd, local_file_path=f"data/pesteh{tomorrow}_2.geojson", remote_file=f"pesteh{tomorrow}_2.geojson")